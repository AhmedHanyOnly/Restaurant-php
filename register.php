    ...
    <div class="box-col d-flex flex-column justify-content-center py-xl-0">
      <form action="./server.php" method="post" class="form_content" enctype='multipart/form-data'>
        ...
        <h3 class="header_title">
          ...
          <div class="text">قم بانشاء حسابك الخاص الان للحصول علي افضل تجربة ممكنه</div>
        </h3>
        <div class="row gap-3 ">
          <div class="col-12 ">
            <label for="" class="label">الأسم</label>
            <div class="group-inp">
              <input type="text" name="name" id="" class="inp">
              <div class="box">
          ...
          <div class="col-12 ">
            ...
            <div class="group-inp">
              <input type="tel" name="phone" id="" class="inp">
              <div class="box">
                <img src="img/login/sms.svg" class="icon" alt="">
              </div>
            </div>
          ...
          <div class="col-12 mb-4">
            <label for="" class="label">الصورة الشخصية</label>
            <div class="group-inp">
              <input type="file" name="image" id="" class="inp" multiple>
            </div>
          </div>
          ...
          <div class="col-12">
            <button type="submit" name="register" class="sub_btn btn btn-primary w-100">تسجيل الدخول</button>
          </div>
          <span class='text-center text'>
            لديك حساب بالفعل ؟ <a href="./login.php" class='text-primary'>سجل الان</a>
          </span>
        </div>
      </form>
    </div>
