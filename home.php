...
$dataProduct = $connect->table('products');
    ...
    <div class="container mt-5">
      ...
      <div class="row g-3">
        ...
        foreach ($dataProduct as $product) {
          ...
          echo '<img src="images/' . $product['image'] . '" alt="' . $product['image'] . '">';
          echo '</div>';
          echo '<h6 class="name">' . $product['name'] . '</h6>';
          echo '<p class="des">' . $product['desc'] . '</p>';
          echo '<p class="des fw-bold">' . $product['price'] . '$</p>';
          echo '</div>';
          echo '<div class="btn-holder">';
          echo '<form action="server.php" method="post">';
          echo '<input type="hidden" name="productId" value="' . $product['id'] . '" />';
          echo '<input type="hidden" name="userId" value="' . $_SESSION['userId'] . '" />';
          echo '<button class="main-btn main-outline" name="addOrder">اطلب الان</button>';
          echo '</form>';
          echo '</div>';
          echo '</div>';
          echo '</div>';
